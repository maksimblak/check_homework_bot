...
async def save_homework_file(
    ...
    :param path_to_answer: корневая директория загрузки ответов по выбранной студентом дисциплине
    ...
    # Формирование пути для сохранения распакованных файлов ответов
    path = Path.cwd()
    path = path.joinpath(
        path_to_answer
    ).joinpath(
    ...
    # Формирование списка путей до распакованных файлов ответов
